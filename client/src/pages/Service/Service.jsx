      ...
      <div className="flex flex-col mt-8 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div
            ...
            className="box-border cursor-pointer bg-[#8a3617] p-2 rounded-lg flex transition-all duration-300 text-white flex-col items-center justify-center drop-shadow space-y-2 border-2 border-transparent hover:bg-white hover:border-[#803B20] hover:text-[#803B20] active:bg-white active:border-[#803B20] active:text-[#803B20]"
          >
