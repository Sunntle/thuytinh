      ...
      <div className="hidden sm:relative sm:grid sm:grid-cols-12 sm:gap-2">
              ...
              <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {data &&
                  data.data.map((product) => (
                    <FoodCard key={product.id} data={product} />
                  ))}
              </div>
            </div>
          </div>
        ...
        <div className="col-span-1 h-full flex flex-col justify-center">
          ...
          >
            ...
            <div
              onTouchStart={() => setIsOrderListOpen(!isOrderListOpen)}
              className="w-12 h-12 lg:w-16 lg:h-16 rounded-full border border-slate-500 flex items-center justify-center shadow-[0_3px_10px_rgb(0,0,0,0.2)]"
            >
        ...
        >
          {/* Close Button */}
          <button onClick={() => setIsOrderListOpen(false)} className="mb-8">
              ...
              <div className="h-full flex justify-between items-start pt-2 pr-2">
                <div className="flex flex-col space-y-3">
                  ...
                  <span className="font-medium text-sm">
                    Giá: <span className="font-normal">1.400.000 VNĐ</span>
                  </span>
                </div>
