...
import { Col, Modal, Table, message, Button, Form, Input, Select, Upload } from 'antd';
const { Option } = Select;
        ...
        <div className='px-5 mt-5'>
            ...
            <Table columns={[
                ...
                },
                {
                    ...
                    key: 'thumbnail',
                    render: (_, record) => (
                        <img src={record.thumbnail} width={100} />
                    )
                },
                {
                    title: 'Ẩn / Hiện',
                ...
                },
                {
                    ...
                    sorter: true,
                    render: (_, record) => (
                        <span>{formatNgay(record.createdAt)}</span>
                    )
                },
                {
                    title: 'Ngày cập nhật',
                    ...
                    sorter: true,
                    render: (_, record) => (
                        <span>{formatNgay(record.updatedAt)}</span>
                    )
                },
                {
                    title: 'Chỉnh sửa',
