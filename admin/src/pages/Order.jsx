...
import { Col, Drawer, Modal, Popconfirm, Row, Table, Tabs, message, Button, Checkbox, Form, Input, Select, DatePicker } from 'antd';
const { Option } = Select;
...
const iii = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpEFsVOFE8XqqekyR9CNQv-Zdm1Rf8bvezhw&usqp=CAU'
...
const OrderPage = () => {
    ...
    const [query, setQuery] = useState({ key_sort: 'createdAt', val_sort: 'DESC' });
                ...
                <Tabs defaultActiveKey="1" items={[
                    {
                        ...
                        >
                            ...
                            <Row gutter={12}>
                                <Col xs={12}>
                                    <Form.Item name="date_order" label="Ngày đặt *(giờ/phút)" {...config}>
                                        <DatePicker showTime format="DD-MM-YYYY HH:mm" placeholder='Ngày giờ đặt' className='w-full' />
                                    </Form.Item>
                                </Col>
                                <Col xs={12}>
                                    <Form.Item
                                    ...
                                    >
                                        <Select
                                            placeholder="Bàn ăn" options={options}
                                        >
